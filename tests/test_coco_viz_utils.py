...
class TestVisualizeBbox:
    ...
    def test_visualize_bbox_success(self, mock_show, sample_coco_data, sample_images):
    ...
    @patch("coco_utils.coco_viz_utils.plt.show")
    def test_visualize_bbox_no_annotations(self, mock_show, sample_coco_data, sample_images):
    ...
    @patch("coco_utils.coco_viz_utils.plt.show")
    def test_visualize_bbox_custom_colors(self, mock_show, sample_coco_data, sample_images):
        """Test bbox visualization with custom colors."""
        visualize_bbox(sample_coco_data, 1, str(sample_images), box_color="blue", box_width=5)
        mock_show.assert_called_once()
...
class TestVisualizeKeypoints:
    ...
    @patch("coco_utils.coco_viz_utils.plt.show")
    def test_visualize_keypoints_no_keypoints(self, mock_show, sample_coco_data, sample_images):
        """Test visualization when annotations have no keypoints."""
        visualize_keypoints(sample_coco_data, 1, str(sample_images))
        mock_show.assert_called_once()

    def test_visualize_keypoints_image_not_found(self, sample_coco_with_keypoints, temp_dir):
